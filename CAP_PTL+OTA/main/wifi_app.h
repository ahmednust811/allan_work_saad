...
#define WIFI_AP_IP					"10.0.0.1"		// AP default IP
#define WIFI_AP_GATEWAY				"10.0.0.1"		// AP default Gateway (should be the same as the IP)
...
typedef enum wifi_app_message
{
	...
	SAVED_BOOT_URL_TO_NVS,
	JWT_ENCODING_SUCCESSFUL,
	PARSING_DONE,
} wifi_app_message_e;
