...
//https request for boot URL
#define HTTP_REQUEST_BOOT_URL_TASK_STACK_SIZE 8192
#define HTTP_REQUEST_BOOT_URL_TASK_PRIORITY   5
#define HTTP_REQUEST_BOOT_URL_TASK_CORE_ID    0
